        ...
        <div className="hero_wrapper flex 2xl:pb-10 xl:pb-10 lg:pb-10 pb-5">
          <div className="hero_description 2xl:w-1/2 xl:w-1/2 lg:w-1/2 w-full">
            ...
            <form
              ...
              className="2xl:flex xl:block lg:block md:block items-center gap-[15px] pt-[116px] 2xl:absolute xl:absolute z-50"
            >
              <Text />
              <div className="flex items-center gap-1 2xl:w-[230px] w-[230px] h-[60px]  2xl:h-[80px]   common_btn rounded-full text-white justify-center font-semibold text-[16px] 2xl:mt-0 mt-5 2xl:absolute xl:absolute 2xl:left-[470px] xl:left-[330px] 2xl:top-[116px] xl:top-[97px]">
